...
import { appRecommendations } from "@/constants/app-recommendations";

const AppRecommendationTrips = async () => {
  const trips = appRecommendations;
...
export default AppRecommendationTrips;
